        ...
        <div class="layout-px-spacing">
            ...
            <div class="page-header my-3">
                <nav class="breadcrumb-one" aria-label="breadcrumb">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">جميع الأصناف</a></li>
                    </ol>
                </nav>
            </div>
                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>الأصناف</h4>
                                    <button class="btn btn-primary"><a href="{{route('products.create')}}"> اضافة صنف</a> </button>
                                    <button class="btn btn-secondary"><a href="{{route('products.export')}}"> تصدير الأصناف</a> </button>
                                </div>
                            </div>
                        </div>
